...
public class BankingAppSpringBootApplication implements CommandLineRunner {

    private static Logger log = LoggerFactory.getLogger(BankingAppSpringBootApplication.class);
...
//    AccountConfig accountService=  new AccountConfig();
...
//        AccountService ctx= accountService.accountService();

//        ctx.getBean("accountService",AccountService.class);

        ExecutorService executor = Executors.newCachedThreadPool();

        log.debug("Welcome to Banking Management App!");
    ...
    private  void addAccount() throws NumberFormatException {
    ...
    private  void captureAccDetail(Account account) throws NumberFormatException {
