...
public class AccountServiceImpl implements AccountService {
    ...
    Scanner s1 = new Scanner(System.in);
        ...
        Account ac1 = new Account(1, "Sanskar", "saving", 14700, "SBI");
        Account ac2 = new Account(2, "Suhail", "current", 56009, "BOB");
        Account ac3 = new Account(3, "Nazir", "loan", 90066, "SBI");
        Account ac4 = new Account(4, "Rajdeep", "loan", 10060, "HDFC");
        Account ac5 = new Account(5, "Mohit", "saving", 10060, "SBI");
        Account ac6 = new Account(6, "Sanskar", "loan", 190700, "BOB");
