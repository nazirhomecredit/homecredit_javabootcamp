...
public class AccountServiceImpl implements AccountService {
    ...
    public synchronized void bulkImport() {
        ...
        int counter = 0;
        try (Scanner in = new Scanner(new FileReader("C:\\Training\\homecredit_javabootcamp\\assignments\\java\\bankingapp-with-impexp\\src\\com\\homecredit\\bankingapp\\service\\account-input.txt"))) {
...
//                accountMap.put(account.getAccountId(),account);
    ...
    public void bulkExport() {
        ...
        try (FileWriter out = new FileWriter("C:\\Training\\homecredit_javabootcamp\\assignments\\java\\bankingapp-with-impexp\\src\\com\\homecredit\\bankingapp\\service\\account-output.txt")) {
            accountMap
